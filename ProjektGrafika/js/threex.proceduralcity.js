...
/*    geometry.faces.splice( 3, 1 );
    ...
    for( var x =0;x < 4 ; x++){
        for( var y =0 ;y < 4 ; y++){
            for( var z =0 ;z < 4 ; z++){
               // console.log(x +',' + y +','+ z +' ' + geometry.faceVertexUvs[x][y][z]);
            }
        }
    }
 ...
 //   geometry.faceVertexUvs[0][2][3].set( 0, 0 );
    ...
    for (var i = 0; i < 3600; i++) {
        ...
        if (x < -10 || z < 20) {
            ...
            buildingMesh.scale.x = Math.random() * Math.random() * Math.random() * Math.random() * 50 + 10;
            buildingMesh.scale.y = (Math.random()  * Math.random() *buildingMesh.scale.x) * 10 + 8;
            buildingMesh.scale.z = buildingMesh.scale.x;
        }
        if (x >-5 && x <5 && z > 25 && z <35 ){
            buildingMesh.scale.x = Math.random() * Math.random() * Math.random() * Math.random() * 50 + 10;
            buildingMesh.scale.y = (Math.random() *  buildingMesh.scale.x) * 15 + 8;
            buildingMesh.scale.z = buildingMesh.scale.x;
        }
